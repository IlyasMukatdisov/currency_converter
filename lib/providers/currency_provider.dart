...
class CurrencyTypeNotifier extends Notifier<Map<String, String>> {
  ...
  build() {
    return {
      Strings.amountCurrency: Strings.uzs,
      Strings.convertedAmountCurrency: Strings.usd,
    };
  }
  ...
  void setAmountCurrency(String amountCurrency) {
    if (amountCurrency == state[Strings.convertedAmountCurrency]) {
      state = {
        Strings.amountCurrency:
            state[Strings.convertedAmountCurrency] ?? Strings.uzs,
        Strings.convertedAmountCurrency:
            state[Strings.amountCurrency] ?? Strings.usd,
      };
      return;
    }
    ...
    state = {
      ...
      Strings.convertedAmountCurrency:
          state[Strings.convertedAmountCurrency]!,
    };
  }
